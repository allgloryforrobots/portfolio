...
export const SkillsBlock= () => {
    return (
        <div className='skill-block'>
            <div className='skill-block__card'>
            ...
            <div className='skill-block__card'>
                ...
                <div className='skill-block__section'>
                    ...
                    <div className='skill-block__row'>React Hook Form</div>
                ...
                <div className='skill-block__section'>
                    ...
                    <div className='skill-block__row'>Redmine</div>
                    <div className='skill-block__row'>BEM (CSS)</div>
                </div>
